...
$userid = $_SESSION['userId'];
	...
	$sql2 ="select * from teacher where staffNo='".$userid."'";
...
<div class="header_right">
	<div class="cssmenu">
		<ul>
			...
			<li><a href="teacherupdate.php"><span>Profile</span></a></li>
				...
				<div class="col span_2_of_4">
				  <div class="contact-form">
				  	<h2 class="style">Edit Your Profile Here</h2>
					       <form id="form1" name="form1" method="post" action="teachersaveinsert.php">
					    	<div>
						    	<span><label>Staff ID</label></span>
						   ...
						   <div>
						    	...
						    	<span><input name="street" type="text" class="textbox"  value="<?php echo $row2[4]; ?>"></span>
						    </div>
							<div>
						     	<span><label>State</label></span>
						    	<span><input name="state" type="text" class="textbox"  value="<?php echo $row2[5]; ?>"></span>
						    </div>
							<div>
						     	<span><label>HandPhone Number</label></span>
						    	<span><input name="mobile" type="text" class="textbox"  value="<?php echo $row2[6]; ?>"></span>
						    </div>
							<div>
						     	<span><label>Email</label></span>
						    	<span><input size="15" name="email" type="text" class="textbox"  value="<?php echo $row2[7]; ?>"></span>
						    </div>
						   <div>
